...
public class CategoryDefinitions{
	...
	WebElement categoryNameField = CommonDefinitions.browser.findElement(By.xpath("//input[@placeholder = '���������']"));
	...
	public void shouldRemoveCategory(String categoryName) throws Throwable {
	    ...
	    WebElement approveRemovingButton = CommonDefinitions.browser.findElement(By.xpath("//div[@class='modal-footer']/button[.='��']"));
